...
<div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">发布拍卖品</strong>
            <small></small>
        </div>
    </div>
            ...
            <div class="admin-content-body">
                <div class="am-g">
                    <form class="am-form am-form-horizontal" id="form"
                          action="${pageContext.request.contextPath}/api/goods/admin/addGoods.html" method="post"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-4">
                                <input required="" value="" name="goodsTitle"
                                       type="text">
                            </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-4">
                                <input required="" value="" name="goodsStartedTime"
                            ...
                            <div class="am-u-sm-4">
                                <input required="" value="" name="goodsEndTime"
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-4">
                                <input required="" value="" name="goodsStartedPrice"
                                       type="text">
                            </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <textarea required="" value="" name="goodsBrief"></textarea>
                            </div>
                        </div>
